...
var Connector = function(port, host, opts) {
  ...
  this.heartbeatInterval = opts.heartbeatInterval || 18;
};
...
Connector.decode = Connector.prototype.decode = function(msg) {
    var index = 0;
    console.log('****debug info****msg:',msg );
    if(isJson(msg)){
        var msg_obj = JSON.parse(msg);
        var id = msg_obj._order_id;
        var route = msg_obj._route_str;
        delete msg_obj._order_id;
        delete msg_obj._route_str;
        var body = JSON.stringify(msg_obj);
